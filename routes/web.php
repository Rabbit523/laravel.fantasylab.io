...
Route::get('/wordpress-service-agreement', 'PagesController@wpService');
...
Route::get('/no/portefolje', 'PagesController@no_portfolio');
Route::get('/no/portefolje/{type?}', 'PagesController@no_singlePortfolio');
...
Route::get('/admin/single-page/wp-service', 'PagesController@adminWPServicePage');
