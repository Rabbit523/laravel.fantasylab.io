				...
				{({ isHovering }) => (
					<React.Fragment>
						...
						<div className='plan-item' style={isMobile ? item_hover : isHovering ? item_hover : {}}>
							<div className={this.props.type == 'wp' ? 'avatar-item wp' : 'avatar-item'} style={isMobile ? avatar_hover : isHovering ? avatar_hover : {}}>
							...
							<div className="options">
								{this.props.type == "hosting" && this.props.options.map((item, i) => (
								...
								{this.props.type == "wp" && this.props.options.map((item, i) => (
									<div className="item wp" key={i}>
										<p>{this.props.lang == 'en' ? item.title : item.no_title}:</p>
										{item.items.map((sel, key) => (
											<div className="sub-item" key={key}>
												<img src="/images/icon-check.png" />
												<p>{this.props.lang == 'en' ? sel.title : sel.no_title}</p>
											</div>
										))}
									</div>
								))}
