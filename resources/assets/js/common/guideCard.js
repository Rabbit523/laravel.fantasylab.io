	...
	render() {
		return (
			<ReactHoverObserver className='guide-card-observer'>
				{({ isHovering }) => (
					<div className={this.props.from == 'service_mobile' ? 'guide-card service' : this.props.from == 'hosting' ? 'guide-card hosting' : 'guide-card'} style={isHovering ? hoverStyle : null}>
