                        ...
                        <div className='service-header' style={{ backgroundImage: `url(${data.header_url})` }}>
                            <div className='header-gradient mobile'>
                                ...
                                <div className='starter-group'>
                                    ...
                                    <Button className='primary-button' style={{marginTop: 20}} onClick={(event) => this.triggerModal(event)}>Craft Enterprise</Button>
                                </div>
                            </div>
                        </div>
                        <div className='service-section review illustration' style={data.starting.length > 3 ? { backgroundImage: `url(${data.study.backimage})`} : { backgroundImage: `url(${data.study.backimage})`}}>
                            <Container className='custom-col-6'>
