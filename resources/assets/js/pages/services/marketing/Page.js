            ...
            <div className='service-page'>
                {isLoaded ?
                    <React.Fragment>
                        ...
                        <div className='service-section review branding' style={data.starting.length > 3 ? { backgroundImage: `url(${data.study.backimage})`} : { background: `url(${data.study.backimage})`}}>
                            <Container className='custom-col-6'>
