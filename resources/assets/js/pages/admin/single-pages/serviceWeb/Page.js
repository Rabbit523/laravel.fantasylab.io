...
class Page extends React.Component {
    ...
    updateHeader() {
        ...
        Http.post('/api/admin/update-page', {name: 'service-web', data: JSON.stringify(list), type: 'header'})
        .then(
            res => {
    ...
    updateFooter() {
        var { list } = this.state;
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', { name: 'service-web', data: JSON.stringify(list), type: 'footer' })
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
    ...
    updateReview() {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'service-web', data: JSON.stringify(reviews), type: 'study'})
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
