...
class Page extends React.Component {
    ...
    componentDidMount() {
        Http.post('/api/front/get-page', { name: 'service-market' })
        .then(
            res => {
    ...
    updateHeader() {
        ...
        Http.post('/api/admin/update-page', {name: 'service-market', data: JSON.stringify(list), type: 'header'})
        .then(
            res => {
    ...
    updateReview() {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'service-market', data: JSON.stringify(reviews), type: 'study'})
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
