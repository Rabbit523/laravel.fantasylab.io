...
class Page extends React.Component {
    ...
    componentDidMount() {
        Http.post('/api/front/get-page', { name: 'service-mobile' })
        .then(
            res => {
    ...
    updateHeader() {
        ...
        Http.post('/api/admin/update-page', {name: 'service-mobile', data: JSON.stringify(list), type: 'header'})
        .then(
            res => {
    ...
    updateFooter() {
        var { list } = this.state;
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', { name: 'service-mobile', data: JSON.stringify(list), type: 'footer' })
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
    ...
    updateReview() {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'service-mobile', data: JSON.stringify(reviews), type: 'study'})
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
    ...
    onUpdateTechItem(e, type) {
        ...
        this.setState({ isLoaded: false });
        Http.post('/api/admin/update-page', {name: 'service-mobile', data: JSON.stringify(technologies), type: 'tech', id: type})
        .then(
            res => {
                this.setState({ isLoaded: true });
            }
